...
export const NAV_ITEMS = [
  { label: 'Home', desc: 'Countdown & overview', href: 'index.html', icon: '🏠' },
  { label: 'Flights', desc: 'All flight details', href: 'index.html#flights', icon: '✈️' },
  { label: 'Itinerary', desc: 'Day by day plan', href: 'itinerary.html', icon: '🗓' },
  { label: 'La Cocumella', desc: 'Our hotel in Sorrento', href: 'index.html#cocumella', icon: '🏨' },
